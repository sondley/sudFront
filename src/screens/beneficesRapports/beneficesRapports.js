...
class BeneficesRapports extends PureComponent {
	constructor(props) {
		super(props);
	...
	render() {
		return (
			<CustomMenu screenName="Rapports du Benefices">
				<div className="prueba-de-contenido">
					<h3>Rapport du Benefices</h3>
				</div>
			</CustomMenu>
		);
	}
...
export default connect(mapStateToProps)(BeneficesRapports);
